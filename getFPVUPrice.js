...
let pancakeSwapContract =
  "0x0A7E6845456D73A29e1Dc8fF3fF0855E08F75b49".toLowerCase();
const web3 = new Web3("https://rpc.factorychain.io");
async function getFPVUPrice() {
  const web3 = new Web3("https://rpc.factorychain.io");
  const BNBTokenAddress = "0x164bec63575f49ac7fc6b68526bbf5205bdbb301"; //BNB
  const USDTokenAddress = "0xd18f0b04bece380d21af2d5b7e9d40e9745a8cd3"; //USDT
...
module.exports = async (bot) => {
  bot.onText(/^\/fpvu$/i, async (msg, match) => {
    const chatId = msg.chat.id;
    const amount = match.input.split(" ")[0];
